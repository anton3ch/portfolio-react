    ...
    <div className="col-md-4 project">
      <div className="card card-s animate__animated animate__headShake">
        <div className="card-body">
          ...
          <a href={props.deployedLink} target="_blank" rel="noreferrer"> <img className="card-img ci1" src={props.img} onMouseOver={e => (e.currentTarget.src = props.imgGit)} onMouseOut={e => (e.currentTarget.src = props.img)} border="0" alt={props.imgAlt} /></a>
